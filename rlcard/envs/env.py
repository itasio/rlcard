...
class Env(object):
    ...
    def __init__(self, config):
        ...
        supported_envs = ['blackjack', 'leduc-holdem', 'limit-holdem', 'no-limit-holdem', 'new-limit-holdem']
    ...
    def reset(self, starter=None, agent=None, hcard=None, pcard1=None, pcard2=None, opcard=None):
        ''' Start a new game
        ...
        '''
        state, player_id = self.game.init_game(starter, agent, hcard, pcard1, pcard2, opcard)
        self.action_recorder = []
